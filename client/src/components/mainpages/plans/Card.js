...
<a href = {githubLink} className = 'bg-gray-600 hover:bg-blue-400 text-white font-bold py-4 px-4 border-b-4 border-yello-700 hover:border-blue-500 rounded w-full ml-8 text-2xl flex justify-center items-center ' target = '_blank' rel="noopener noreferrer"><AiOutlineGithub /></a>
<a href = { demo } className = 'bg-yellow-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-yello-700 hover:border-blue-500 rounded w-full mr-8  text-center' target = '_blank' rel="noopener noreferrer">Live Demo</a>
</div>
</div>
